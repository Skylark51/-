...
assert.ok(html.includes('shop-outfit-layout.css?v=20260805-outfit5'), "outfit layout cache key must be current");
assert.ok(html.includes('shop-navigation.js?v=20260805-outfit5'), "shop renderer cache key must be current");
