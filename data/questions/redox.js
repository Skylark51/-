import{binary}from'./_choice.js';const O={label:'산화',value:'oxidation'},R={label:'환원',value:'reduction'},OX={label:'산화제',value:'oxidizing_agent'},RE={label:'환원제',value:'reducing_agent'},UP={label:'산화수 증가',value:'increase'},DOWN={label:'산화수 감소',value:'decrease'},GAIN={label:'전자 획득',value:'gain'},LOSS={label:'전자 상실',value:'loss'};
export const redoxQuestions=Object.freeze([
binary('redox_001','redox',1,'H₂ → 2H⁺ + 2e⁻에서 H의 변화는?',O,R,'1','전자를 잃었으므로 산화입니다.',['산화 환원','전자 상실']),
binary('redox_002','redox',1,'O₂ + 4e⁻ → 2O²⁻에서 O₂의 변화는?',O,R,'2','전자를 얻었으므로 환원입니다.',['산화 환원','전자 획득']),
...
binary('redox_011','redox',2,'Mg + 2H⁺ → Mg²⁺ + H₂에서 Mg는?',OX,RE,'2','Mg는 전자를 주고 산화되므로 환원제입니다.',['환원제','반응식']),
binary('redox_012','redox',2,'Mg + 2H⁺ → Mg²⁺ + H₂에서 H⁺는?',OX,RE,'1','H⁺는 전자를 받아 환원되므로 산화제입니다.',['산화제','반응식']),
...
binary('redox_015','redox',3,'Cl₂ + 2F⁻ → 2Cl⁻ + F₂에서 Cl₂는?',OX,RE,'1','Cl₂는 전자를 받아 환원되며 산화제로 작용합니다.',['산화제','할로젠']),
binary('redox_016','redox',3,'Cl₂ + 2F⁻ → 2Cl⁻ + F₂에서 F⁻는?',OX,RE,'2','F⁻는 전자를 주고 산화되며 환원제로 작용합니다.',['환원제','할로젠'])
]);
