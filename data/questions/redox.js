...
const O={label:"산화",value:"oxidation"},R={label:"환원",value:"reduction"},OX={label:"산화제",value:"oxidizing_agent"},RE={label:"환원제",value:"reducing_agent"},UP={label:"산화수 증가",value:"increase"},DOWN={label:"산화수 감소",value:"decrease"},GAIN={label:"전자 획득",value:"gain"},LOSS={label:"전자 상실",value:"loss"},ZN={label:"Zn",value:"Zn"},CU2={label:"Cu²⁺",value:"Cu2+"};
...
binary("redox_017","redox",3,"Zn + Cu²⁺ → Zn²⁺ + Cu에서 산화된 물질은?",ZN,CU2,"1","Zn은 전자를 잃고 Zn²⁺으로 산화됩니다.",["산화된 물질","반응식"]),
binary("redox_018","redox",3,"Zn + Cu²⁺ → Zn²⁺ + Cu에서 환원된 물질은?",ZN,CU2,"2","Cu²⁺은 전자를 얻고 Cu로 환원됩니다.",["환원된 물질","반응식"])
]);
